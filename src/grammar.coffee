...
grammar =
  ...
  Assign: [
    ...
    o 'Assignable = INDENT Pattern OUTDENT',    -> new Assign $1, new Pattern($4)
    o 'Assignable = INDENT Expression OUTDENT', -> new Assign $1, $4
  ]

  # Pattern Matching. Allows you to specify multiple code blocks in a single
  # assignment.
  Pattern: [
    o 'Code',                                   -> [$1]
    o 'Pattern TERMINATOR Code',                -> $1.concat $3
  ]
